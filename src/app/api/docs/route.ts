...
// Define the OpenAPI Specification for PVL CRM API
const SOURCE_FIELD = {
    type: 'string',
...
<html>
  <head>
    <title>PVL CRM API Reference</title>
    <meta charset="utf-8" />
    <meta
      name="viewport"
