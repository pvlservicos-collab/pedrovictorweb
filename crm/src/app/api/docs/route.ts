...
// Define the OpenAPI Specification for ImobEasy CRM API
const SOURCE_FIELD = {
    type: 'string',
...
<html>
  <head>
    <title>ImobEasy CRM API Reference</title>
    <meta charset="utf-8" />
    <meta
      name="viewport"
