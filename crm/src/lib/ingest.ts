...
async function authenticate(req: NextRequest) {
  // So Bearer conta como credencial de API: o navegador de quem passou pela
  // senha do /crm manda `Authorization: Basic` em tudo, e isso nao e token.
  if (req.headers.get('authorization')?.startsWith('Bearer ')) return authenticateRequest(req)
